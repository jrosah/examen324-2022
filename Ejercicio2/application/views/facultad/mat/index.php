...
<main>
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?php echo site_url(); ?>/assets/img/mat-1.png" alt="" width="100%">
      ...
      <div class="carousel-item">
        <img src="<?php echo site_url(); ?>/assets/img/mat-2.png" alt="">
      ...
      <div class="carousel-item">
        <img src="<?php echo site_url(); ?>/assets/img/mat-3.png" alt="">
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Carrera de Matemática</h1>
            <p>
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img src="<?php echo site_url(); ?>/assets/img/3.png" alt="" width="500px">
      </div>
    </div>
